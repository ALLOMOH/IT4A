...
export default function Contact() {
  ...
  const handleSubmit = async (e:any) => {
    ...
    try {
      // // Get current user to send email from their account
      // const currentUser = await User.me();

      // // Create a formatted message that will be sent from the user to themselves
      // const emailBody = `
      ...
      //   Ce message a été envoyé depuis le formulaire de contact du site ITExperts4Africa.
      //   Veuillez répondre directement à l'adresse: ${formData.email}
      // `;

      // await SendEmail({
      //   to: currentUser.email,
      //   subject: `[ITExperts4Africa] Nouveau message de contact de ${formData.name}`,
      //   body: emailBody,
      //   from_name: "Site ITExperts4Africa"
      // });
      ...
      if (err.message?.includes("not logged in")) {
        ...
        setError("Erreur lors de l'envoi du message. Veuillez réessayer ou nous contacter directement par téléphone.");
      }
    } finally {
            ...
            <div>
              <div className="bg-white/10 border-none shadow-lg h-full ">
                ...
                <div className="p-8 pt-0">
                  {isSubmitted ? (
                      <Alert className="border-green-200/20 bg-green-50/30 backdrop-blur-2xl ">
                  ...
                  >
                    <div className="p-6">
                      <div className="flex items-center justify-center space-x-2">
                        ...
                        <div className="flex flex-col flex-1 justify-center items-star">
